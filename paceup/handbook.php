...
<div class="col-sm-5"> <h4 class="text-center">Reduce health problems</h4>
...
<p class="text-center">Arthritis and Back pain</p></div>
...
</div><div class="col-sm-2"></div> <div class="col-sm-5">
<h4  class="text-center">Help maintain a healthy weight</h4>
<p  class="text-center">Walking regularly can:</p>
<p class="text-center">Help you to maintain a healthy weight</p>
<p class="text-center">Prevent obesity </p>
</div></div>
<h4  class="text-center"> Which of these benefits are most important for you? </h4>
</div>
</div>
</div>
<div class="panel panel-default">
...
<h4> Moderate intensity activity means that you should:</h4>
<ul type='circle'>
...
<p>ASSUME ADVICE WILL CHANGE HERE re pedometer?</p> </div>
<div class="col-sm-6">
...
<p><b>Once you have signed up, you will wear the pedometer and record your steps for a week</b></p>
<p><b>Then, the average number of steps you walked in a day will be calculated. Let's say you walked 5000 steps in a day</b></p>
