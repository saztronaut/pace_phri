		...
		document.getElementById("thisHeader").innerHTML= "<h2> Baseline week of your walking plan</h2>";
		 blurb="<p> Before you start to increase your walking it is important to know how much you are currently doing. The best way to do this is for you to wear the pedometer and record our step counts each day for a full week. There is often quite a difference between weekends and weekdays, so it is important to try and record for a full week. Don't try to increase your walking this week, just do what you normally do, or your targets will be too high and too hard for you to achieve</p>";
			document.getElementById("thisBlurb").innerHTML= blurb;
	         thisAside="<p> Before you start to increase your walking it is important to know how much you are currently doing. The best way to do this is for you to wear the pedometer and record our step counts each day for a full week. There is often quite a difference between weekends and weekdays, so it is important to try and record for a full week. Don't try to increase your walking this week, just do what you normally do, or your targets will be too high and too hard for you to achieve</p>";
...
week to your baseline steps.</p> <br> \
<p>One good way to do this is to add in a 15 minute walk.<p>";
...
<p><i>Walking is man’s best medicine. ~ Hippocrates</i></p> <br> \
...
<ul type='circle'> \
 ...
 <p> Remember your personal benefits from increasing walking (see page 3 of PACE-UP handbook) </p> <br> \
...
<p> <i>Walking:  the most ancient exercise and still the best modern exercise.  ~Carrie Latet</i></p>";
			          break;					
				case 3:					
			          blurb="<p> Your aim for week 3 is to add in an extra 1500 steps on five or more days this \
week to your baseline steps.</p> <br> \
<p>One good way to do this is to add in a 15 minute walk.<p>";
			          thisAside = "<h2>Keep it up!s</h2> \
...
<p> <i>People say that losing weight is no walk in the park.  When I hear that I think, yes, that's the problem.  ~Chris Adams	</i></p>";
				  break;				
				case 4:					
...
<p><b>Obstacle:</b>  'I don’t have the time to do a 30 minute walk …. I am so pushed for time already' </p> \
<p><b>Solution:</b>  You don’t have to do your 30 minute walk in one go, you can break it up into walks of 10 or 15 minutes, spread throughout the day. </p> \
<p><b>Obstacle:</b> 'It’s raining and I’ll be soaked when I arrive for the meeting' </p> \
...
<p>Think about how you might overcome these obstacles.  List a range of possible solutions and be prepared to experiment to find out what works best. </p> <p><i> Motivation is what gets you started. Habit is what keeps you going. Anonymous</i> </p>";
				  break;					
				case 6:					
...
<p> <i>I have two doctors, my left leg and my right.  ~G.M. Trevelyan</i></p>";
				  break;
				case 7:					
