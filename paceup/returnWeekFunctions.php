...
if (function_exists('returnWeek')=== false){
	function returnWeek($username){
		...
		// Fetch targets data (number of targets, date latest target, steps, days
...
function numTargets($username){
	// for a given user, return number of targets set, date of latest target, target number of steps and target number of days
		require 'database.php';
