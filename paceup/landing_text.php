...
<div class="row">
  ...
  <p><a href="#" onclick='redirect("./targets_explained.php")'>Click here to see a brief overview</a></div>
  ...
  <p> Findings are reported on <a href="www.paceup.sgul.ac.uk"> the PACE-UP website</a>
  and in <a href="www.journals.plos.org/plosmedicine">PLOS Medicine</a>
  </p></div>
</div>
