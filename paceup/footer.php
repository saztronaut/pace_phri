...
<div class= "row"> <div  class = "col-lg-6"> <p> <img src="images/puns.png" class="img-responsive"  alt="logo"></div>
<div  class = "col-lg-6 "><div class="well"><div class="row"><div  class = "col-sm-6  col-lg-7"><div class="row"><div  class = "col-lg-6"><p><i> Supported by: </i></p></div> <!-- col-->
	  <div  class = "col-lg-6"><p><img src="images/sgul.png" class="img-responsive" alt="SGUL logo"> </p></div></div></div>
	  <div  class = "col-sm-6 col-lg-5"><p><img src="images/nihr.png" class="img-responsive" alt="NiHR support"></p></div><!-- col --></div><!-- row --> </div><!-- well --></div> <!-- row --></div>
