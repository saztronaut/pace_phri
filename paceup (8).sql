...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 10, 2017 at 06:13 PM
...
CREATE TABLE IF NOT EXISTS `feedback` (
  `field` varchar(12) COLLATE utf8_general_mysql500_ci NOT NULL,
  `username` varchar(30) COLLATE utf8_general_mysql500_ci NOT NULL,
  `answer` varchar(255) COLLATE utf8_general_mysql500_ci NOT NULL
...
CREATE TABLE IF NOT EXISTS `questions` (
  `field` varchar(12) COLLATE utf8_general_mysql500_ci NOT NULL COMMENT 'name of the field for questionnaire',
  `question` varchar(255) COLLATE utf8_general_mysql500_ci NOT NULL COMMENT 'question to display',
  `show_this` tinyint(4) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_mysql500_ci;
...
ALTER TABLE `feedback`
  ADD CONSTRAINT `feedback_ibfk_1` FOREIGN KEY (`username`) REFERENCES `users` (`username`) ON DELETE CASCADE, 
  ADD CONSTRAINT `feedback_ibfk_2` FOREIGN KEY (`field`) REFERENCES `questions` (`field`) ;
--
